...
from robosuite.wrappers import RL_agent_2, GymWrapper, PolishingGymWrapper
...
if __name__ == "__main__":
    ...
    model = SAC.load("/hpcwork/thes1499/10_8/exp/Polishing/CRL_s_9_h_0.6_stp_10/2023.09.27/234923/best_model.zip")
