"""
This file implements a SplitWrapper for facilitating compatibility with OpenAI gym.
A split policy is implemented to combine the actions from the base-controller and the RL agent.
Base controller is assigned to provide the position commands and the RL agent is assigned to provide the variable gains
"""
...
class SplitWrapper(Wrapper, gym.Env):
    metadata = None
    render_mode = None
    """
    ...
    def step(self, action):
        ...
        # the position commands are computed as the base controller's signal and concatenated to the RL agent's action
