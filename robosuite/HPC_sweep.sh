...
#SBATCH --output=/hpcwork/ru745256/master_thesis/30_6/robosuite/robosuite/task_out.%J.out
#SBATCH --error=/hpcwork/ru745256/master_thesis/30_6/robosuite/robosuite/error_task_out.%J.out
...
wandb agent master_thesis_ap/HPC_sweep/umb1z52h --count=700